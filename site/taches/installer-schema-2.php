...
/* ==================================================================
   Installation ponctuelle du schema manquant (reinscriptions, biblio
   adherents, support, mailings). TEMPORAIRE : a supprimer juste apres
   usage. Toutes les instructions sont des CREATE TABLE IF NOT EXISTS,
   sans danger a rejouer.
   ================================================================== */
